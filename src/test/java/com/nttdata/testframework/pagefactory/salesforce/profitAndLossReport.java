...
public class profitAndLossReport extends PageObject {
    ...
    public void profitLossFP(String term, String TransformationFund) throws InterruptedException, IOException {
        ...
        String Subscription_YearTwo;
        String Subscription_Year_Two;
        int Subscription_Year_Two_value;
        if(term.equals("24")){
            Subscription_YearTwo = SubscriptionYearTwo.getText();
            Subscription_Year_Two= Subscription_YearTwo.replace(",", "");
            Subscription_Year_Two_value= Integer.parseInt(Subscription_Year_Two);
        }else{
            Subscription_Year_Two_value =0;
        }
...
//        int Subscription_Year_Two_value= Integer.parseInt(Subscription_Year_Two);
        ...
        String Total_BilledRevenueYearTwo;
        String Total_Billed_RevenueYearTwo;
        int Total_Billed_Revenue_Year_Two_value;
        if(term.equals("24")){
            Total_BilledRevenueYearTwo = TotalBilledRevenueYearTwo.getText();
            Total_Billed_RevenueYearTwo= Total_BilledRevenueYearTwo.replace(",", "");
            Total_Billed_Revenue_Year_Two_value= Integer.parseInt(Total_Billed_RevenueYearTwo);
        }else{
            Total_Billed_Revenue_Year_Two_value =0;
        }
...
//        int Total_Billed_Revenue_Year_Two_value= Integer.parseInt(Total_Billed_RevenueYearTwo);
        ...
        String NetRevenue_YearTwo;
        String NetRevenue_Year_Two;
        int Net_Revenue_Year_Two_value;
        if(term.equals("24")){
            NetRevenue_YearTwo = NetRevenueYearTwo.getText();
            NetRevenue_Year_Two= NetRevenue_YearTwo.replace(",", "");
            Net_Revenue_Year_Two_value=Integer.parseInt(NetRevenue_Year_Two);
        }else{
            Net_Revenue_Year_Two_value =0;
        }
...
//        int Net_Revenue_Year_Two_value=Integer.parseInt(NetRevenue_Year_Two);
        ...
        String AirtimeRevenue_YearTwo;
        String AirtimeRevenue_Year_Two;
        int Airtime_Revenue_Year_Two_value;
        if(term.equals("24")){
             AirtimeRevenue_YearTwo = AirtimeRevenueYearTwo.getText();
             AirtimeRevenue_Year_Two= AirtimeRevenue_YearTwo.replace(",", "");
            Airtime_Revenue_Year_Two_value=Integer.parseInt(AirtimeRevenue_Year_Two);
        }else{
            Airtime_Revenue_Year_Two_value =0;
        }
...
//        int Airtime_Revenue_Year_Two_value=Integer.parseInt(AirtimeRevenue_Year_Two);
        ...
        String SimCost_YearTwo;
        String SimCost_Year_Two;
        int Sim_Cost_Year_Two_value;
        if(term.equals("24")){
            SimCost_YearTwo = SimCostYearTwo.getText();
            SimCost_Year_Two= SimCost_YearTwo.replace(",", "");
            Sim_Cost_Year_Two_value=Integer.parseInt(SimCost_Year_Two);
        }else{
            Sim_Cost_Year_Two_value =0;
        }
...
//        int Sim_Cost_Year_Two_value=Integer.parseInt(SimCost_Year_Two);
        ...
        String CapitaCost_YearTwo;
        String CapitaCost_Year_Two;
        int Capita_Cost_Year_Two_value;
        if(term.equals("24")){
            CapitaCost_YearTwo = CapitaCostYearTwo.getText();
            CapitaCost_Year_Two= CapitaCost_YearTwo.replace(",", "");
            Capita_Cost_Year_Two_value=Integer.parseInt(CapitaCost_Year_Two);
        }else{
            Capita_Cost_Year_Two_value =0;
        }
...
//        int Capita_Cost_Year_Two_value=Integer.parseInt(CapitaCost_Year_Two);
        ...
        String TotalCost_YearTwo;
        String TotalCost_Year_Two;
        int Total_Cost_Year_Two_value;
        if(term.equals("24")){
            TotalCost_YearTwo = TotalCostYearTwo.getText();
            TotalCost_Year_Two= TotalCost_YearTwo.replace(",", "");
            Total_Cost_Year_Two_value=Integer.parseInt(TotalCost_Year_Two);
        }else{
            Total_Cost_Year_Two_value =0;
        }
...
//        int Total_Cost_Year_Two_value=Integer.parseInt(TotalCost_Year_Two);
        ...
        String Margin_YearTwo;
        String Margin_Year_Two;
        int Margin_Year_Two_value;
        if(term.equals("24")){
            Margin_YearTwo = MarginYearTwo.getText();
            Margin_Year_Two= Margin_YearTwo.replace(",", "");
            Margin_Year_Two_value=Integer.parseInt(Margin_Year_Two);
        }else{
            Margin_Year_Two_value=0;
        }
...
//        int Margin_Year_Two_value=Integer.parseInt(Margin_Year_Two);
        ...
        String OverallTotalRevenue_YearTwo;
        String OverallTotalRevenue_Year_Two;
        int Overall_Total_Revenue_Year_Two_value;
        if(term.equals("24")){
            OverallTotalRevenue_YearTwo = OverallTotalRevenueYearTwo.getText();
            OverallTotalRevenue_Year_Two= OverallTotalRevenue_YearTwo.replace(",", "");
            Overall_Total_Revenue_Year_Two_value=Integer.parseInt(OverallTotalRevenue_Year_Two);
        }else{
            Overall_Total_Revenue_Year_Two_value=0;
        }
...
//        int Overall_Total_Revenue_Year_Two_value=Integer.parseInt(OverallTotalRevenue_Year_Two);
        ...
        String OverallTotalCost_YearTwo;
        String OverallTotalCost_Year_Two;
        int Overall_Total_Cost_Year_Two_value;
        if(term.equals("24")){
            OverallTotalCost_YearTwo = OverallTotalCostYearTwo.getText();
            OverallTotalCost_Year_Two= OverallTotalCost_YearTwo.replace(",", "");
            Overall_Total_Cost_Year_Two_value=Integer.parseInt(OverallTotalCost_Year_Two);
        }else{
            Overall_Total_Cost_Year_Two_value=0;
        }
...
//        int Overall_Total_Cost_Year_Two_value=Integer.parseInt(OverallTotalCost_Year_Two);
        ...
        String OverallTotalMargin_YearTwo;
        String OverallTotalMargin_Year_Two;
        double Overall_Total_Margin_Year_Two_value;
        if(term.equals("24")){
            OverallTotalMargin_YearTwo = OverallTotalMarginYearTwo.getText();
            OverallTotalMargin_Year_Two= OverallTotalMargin_YearTwo.replace(",", "");
            Overall_Total_Margin_Year_Two_value= Integer.parseInt(OverallTotalMargin_Year_Two);
        }else{
            Overall_Total_Margin_Year_Two_value =0;
        }
...
//        double Overall_Total_Margin_Year_Two_value= Integer.parseInt(OverallTotalMargin_Year_Two);
        ...
        String MarginPercentage_YearTwo;
        String MarginPercentage_Year_Two;
        double Margin_Percentage_Year_Two_value;
        if(term.equals("24")){
            MarginPercentage_YearTwo = MarginPercentageYearTwo.getText();
            MarginPercentage_Year_Two= MarginPercentage_YearTwo.replace(",", "");
            Margin_Percentage_Year_Two_value= Double.parseDouble(MarginPercentage_Year_Two);
        }else{
            Margin_Percentage_Year_Two_value =0.0;
        }
