...
@FindBy(how= How.XPATH, using = "//*[@id='Unified_Recording:LICENSE_INFORMATION:License_Term_0']")
    public static WebElement term_mobRec;
    @FindBy(how= How.XPATH, using = "//*[@id='Unified_Recording:LICENSE_INFORMATION:Quantity_0']")
    public static WebElement qty_mobRec;
    @FindBy(how= How.XPATH, using = "//*[@id='Unified_Recording:LICENSE_INFORMATION:Solution_Category_0']")
...
public static  WebElement MobileRecording;
    ...
    public static WebElement solution_textField;
...
//        dropDown(solution_mobRec,MobRcordingsolution);
        dropDownIndex(solution_mobRec,1);
        Thread.sleep(5000);
        clickElement(solution);
        wait1.until(ExpectedConditions.visibilityOf(solution_textField));
        sendKeys(solution_textField,"Business Lite");
        Thread.sleep(4000);
        solution_textField.sendKeys(Keys.ENTER);
