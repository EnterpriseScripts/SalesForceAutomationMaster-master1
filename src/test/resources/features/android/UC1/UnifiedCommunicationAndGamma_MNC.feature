Feature: Enterprise industrialisation
  ...
  @Test
  Scenario Outline: To verify that salesRepresentative is able to complete an E2E order successfully with HostedMI, MobileRecording and InboundNumbers products in the same basket for MNC account
    ...
    Then Sales rep adds an retail product with required details
      ...
      |Communication      |Collaboration    |Unified Recording (UR) |200    |1   |500              |15000               |New / Additional|
    ...
    Examples:
      ...
      |ID_017 ID_063 ID_112 ID_163 ID_216 |    12    |      500      |Premium Availability|Active - Standby|Mainstream Phone (5324)|   234    |Handset Installation|Survivable Gateway 3300 CX|   765   |Port Multi-line|       345     | New DDI |  543     |Bespoke|    455      |     12       |    CC2     |CC2 |          23             |      24       |   25   |             26             |       Area Plans    |        12          |      SMS Only      |        Yes      |          Yes          |Call Recording|Inbound Numbers (TalkTalk) | 12 |1000+ Sites  | Acquisition| Self-serve pricing tools | Mobile           | Voice & Data   | Voice & Data  |  3500 |  1  |         40000   |           45000   | Blended Margin >17.5% Annuity >20% | First submission | Standard TEF UK Ts & Cs | Standard       | No        | No   | No         |2000|Voice & Data|Unlimited |Individual |
